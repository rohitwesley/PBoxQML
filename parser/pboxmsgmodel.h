#ifndef PBOXMSGMODEL_H
#define PBOXMSGMODEL_H

#include <QSqlTableModel>

class PboxMsgModel : public QSqlTableModel
{
    Q_OBJECT
...
private:
    QString m_recipient;
    QString m_sender= QStringLiteral("PBoxTreeRoot");

};

#endif // PBOXMSGMODEL_H
