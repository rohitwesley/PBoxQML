...
//===================================================================
void Mesh::setCustomShaders(const QString &vertexFile, const QString &fragmentFile, const QString &geometryFile)
{
    mfshName = fragmentFile;
    mvshName = vertexFile;
    mCustomShader = true;
}
